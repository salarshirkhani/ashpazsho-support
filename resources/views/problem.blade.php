...
.feature {
    ...
    margin: 30px 26px 0px 0px;
                    ...
                    @if(Auth::check())
                    <!--START---- FormAfzar.Com ----->
                    <script type="text/javascript" src="https://formafzar.com/pages/formbuilder/ravesh-formbuilder.js" form-url="https://formafzar.com/form/b5154" form-style="inline" form-theme=""></script>
                    <!--END--- FormAfzar.Com ----->
                    @else
                    <a href="{{route('register')}}" class="btn btn-inline">برای ثبت فرم آنلاین باید در سایت ثبت نام کنید یا وارد شوید</a>
                    @endif
