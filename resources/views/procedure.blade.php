                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <input type="text" class="form-control"  name="name" required  placeholder="عنوان">
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="form-group">
                                    @if(Auth::check())
                                    <input type="text" class="form-control" required value="{{ Auth::user()->first_name }} {{ Auth::user()->last_name }}" name="title" placeholder="نام شما">
                                    @else
                                    <input type="text" class="form-control" name="title" required placeholder="نام شما">
                                    @endif
                                </div>
                            </div>
                            <div class="col-lg-6">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    @if(Auth::check())
                                    <input type="text" class="form-control" name="number" required value="{{ Auth::user()->mobile }}" placeholder="شماره همراه شما" >
                                    @else
                                    <input type="text" class="form-control" name="number" required placeholder="شماره همراه شما">
                                    @endif
                                </div>
                            </div>
                            <div class="col-lg-12">
                            ...
                            <div class="col-lg-12">
                                <div class="form-group">
                                    <label for="file">اگر فایلی دارید در قسمت زیر بارگذاری کنید</label>
                            ...
                            <div class="col-lg-12">
                                <div class="form-group">
                                    <textarea class="form-control" name="content" required placeholder="توصیف کامل مشکل شما"></textarea>
                                </div>
                            </div>
                            <div class="col-lg-12">
                                <div class="form-btn">
