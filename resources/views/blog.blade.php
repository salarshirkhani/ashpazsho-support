...
@section('content')
<link rel="stylesheet" href="{{asset('style/blog-style/blog-des.css')}}" media="only screen and (min-width: 993px)">
<link rel="stylesheet" href="{{asset('style/blog-style/blog-mobile.css')}}" media="(max-width:992px)">
        ...
        <div class="col-lg-12 col-12">
            ...
            <div class="newblogs animation" >
                ...
                <div class="newblogdets">
                    <a href="{{route('single',['id'=>$item->slug])}}"><h4>{{$item->title}}</h4></a>
                    <p>{!! \Illuminate\Support\Str::limit($item->explain, 120, ' ...') !!} </p>
                </div>
            </div>
            <!-- end box blog -->
            @endforeach  
