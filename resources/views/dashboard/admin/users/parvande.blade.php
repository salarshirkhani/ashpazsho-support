...
@endif
    <div class="col-md-12">
        <x-card type="info">
            ...
            <form action="{{route('dashboard.admin.users.par')}}" style="padding:15px;" method="POST">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <div class="form-group">
                            <label for="supervisor">سوپروایزر</label>
                            <select class="form-control" name="supervisor" required label="سوپروایزر">
                                @isset($user->supervisor)
                                <option class="form-control" value="{{ $user->supervisor }}">{{ $user->supervisor }}</option>
                                @endisset
                                <option class="form-control" value="موید سلمانی">موید سلمانی</option>
                                <option class="form-control" value="مهرداد خلیلی">مهرداد خلیلی</option>
                            </select>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="form-group">
                            <label for="darmangar">درمانگر</label>
                            <select class="form-control" name="darmangar" required label="درمانگر">
                                @isset($user->doctors)
                                <option class="form-control" value="{{ $user->doctors }}">{{ $user->doctors }}</option>
                                @endisset
                                @foreach($doctors as $item)
                                 <option class="form-control" value="{{$item->first_name}} {{$item->last_name}}">{{$item->first_name}} {{$item->last_name}}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
