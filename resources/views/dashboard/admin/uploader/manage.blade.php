...
@section('hierarchy')
    ...
    <x-breadcrumb-item title="مدیریت فایل ها" route="dashboard.admin.news.manage" />
@endsection
@section('content')
                        ...
                        <table id="example2" class="table table-bordered table-hover">
                            ...
                            <tr>
                             ...
                             @foreach($posts as $item)
                                <tr>
                                    <td>{{ $item->id }}</td>
                                    <td>http://iranmedslp.com/images/{{ $item->link }}/{{ $item->link }}</td>
                                    <td><img src="{{ asset('images/'.$item['link'].'/'.$item['link'] ) }}" style="width:120px;" ></td>
                                    <td>
