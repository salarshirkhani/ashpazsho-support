        ...
        <ul>
          <li>
            <a href="{{route('dashboard.customer.index')}}" onmouseover="mousehover1()" onmouseout="mouseunhover1()">
              ...
              <path class="hometabpath2" d="M12.6875 25.737H22.8637" stroke="#555555" stroke-linecap="round" stroke-linejoin="round"></path></svg>پرونده الکترونیک
            </a>
          </li>
          <li>   
            <a href="{{route('dashboard.customer.consultant.manage')}}" onmouseover="mousehover2()" onmouseout="mouseunhover2()">
          ...
          <li>
            <a href="{{route('dashboard.customer.response.manage')}}">
