                        <h4 style="margin-top:45px; font-weight:900">واریز دای</h4>
                        <p> شما در حال واریز دای هستید . لطفا پس از واریز دکمه نارنجی رنگ واریز کردم را بزنید تا سیستم وارد پروسه بررسی صحت واریزی شما به صورت خودکار شود</p>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-9 col-sm-12">
                                    <div class="address">
                                        ...
                                        <p class="alert alert-warning">شبکه واریز دای BSC(bep20) است</p>
                        ...
                        <h4 style="margin-top:105px; font-weight:900">سوابق مالی دای</h4>
