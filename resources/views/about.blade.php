...
<div class="container" style="text-align: justify; margin-top:-250px">
                <div class="row">
                    <div class="col-lg-12">
                    ...
                    <div class="col-md-6 col-sm-12">
                        <div class="section-center-heading" style="text-align: justify;">
                            <h2>
                                <span style="color: #2d8e93 ; font-family: 'KalamehWeb_Black'; font-size:50px;">چرا اوستا</span>
                            </h2>
...
گروه بلع‌درمانی ایران‌ مد اس ال پی در سال 1396 و با همت یک مجموعه جوان متخصص برای نخستین بار در سیستم درمانی کشور ایجاد شده است. هدف ما در این گروه ارائه خدمات با کیفیت حداکثری به بیماران دارای اختلال بلع بوده است.
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        <div class="section-center-heading" style="text-align: justify;font-family: KalamehWeb_Black; margin:40px 0px;">
                            <h2 style="color: #2d8e93 ; font-family: 'KalamehWeb_Black';">درباره وب سایت گفتار درمانی ما</h2>
                            <p style="color:#767676; font-family: 'iranyekan';">
