...
@section('content')
<link rel="stylesheet" href="{{asset('style/persons/persons-des.css')}}" media="only screen and (min-width: 993px)">
<link rel="stylesheet" href="{{asset('style/persons/persons-mob.css')}}" media="(max-width:992px)">
<style>
    .contact-info h3 {
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="section-center-heading" style="text-align: justify;">
                            <h2 style="color: #2d8e93 !important; font-family: 'KalamehWeb_Black';">درباره سیستم نوبت دهی اوستا    </h2>
        ...
        <div class="row">
            <div class="col-lg-12 col-12">
                <div class="header-p6">
                    ...
                    <h3 class="head-p6">پزشکان اوستا</h3>
                </div>
            </div>
            @foreach($posts as $item) 
            <div class="col-lg-4 col-md-6 col-sm-12">
                <div class="box-person" style="margin-top: 75px;">
                    <a href="{{route('profile',['id'=>$item->id])}}" class="blog-avatar profile-avatar">
                        <img src="{{ asset('images/'.$item['pic'].'/'.$item['pic'] ) }}" alt="author">
                    </a>
